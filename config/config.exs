...
config :derpy_tools, DerpyToolsWeb.Endpoint,
  ...
  pubsub_server: DerpyTools.PubSub,
  live_view: [signing_salt: "HKZZobRP"]
...
config :derpy_tools, DerpyTools.Mailer, adapter: Swoosh.Adapters.Local
...
config :esbuild,
  ...
  default: [
    args:
      ~w(js/app.js --bundle --target=es2017 --outdir=../priv/static/assets --external:/fonts/* --external:/images/* --external:/snippets/*),
