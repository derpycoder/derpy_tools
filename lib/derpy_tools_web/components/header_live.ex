          ...
          <div class="-mr-1.5 flex items-center space-x-2">
            ...
            <div class="group relative mr-4 flex h-8">
              <input
                ...
                class="cursor-pointer form-input peer h-full rounded-full bg-slate-150 px-4 pl-9 text-xs+ text-slate-800 ring-primary/50 hover:bg-slate-200 focus:ring dark:bg-navy-900/90 dark:text-navy-100 dark:placeholder-navy-300 dark:ring-accent/50 dark:hover:bg-navy-900 dark:focus:bg-navy-900"
              ...
              <span class="absolute right-3 flex items-center justify-center h-full pointer-events-none">
