defmodule DerpyToolsWeb.HeaderLive do
  ...
  def toggle_dark_mode(js \\ %JS{}) do
    js
    |> JS.remove_class("dark", to: "html.dark")
    |> JS.add_class("dark", to: "html:not(.dark)")
    |> JS.toggle(
      to: "#day",
      # in: {
      #   "transition-transform duration-1000 ease-out absolute origin-bottom",
      #   "scale-75",
      #   "scale-100 static"
      # },
      # out: {
    ...
    |> JS.toggle(
      to: "#night",
      # in: {
      #   "transition-transform duration-1000 ease-out absolute origin-top",
      #   "scale-75",
      #   "scale-100 static"
      # },
      # out: {
